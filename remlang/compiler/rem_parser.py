...
trailer = AstParser([LiteralParser('!', name="\'!\'"),LiteralParser('[', name="\'[\'"),Ref('exprCons'),LiteralParser(']', name="\']\'")],[LiteralParser('\'', name="\'\\'\'"),Ref('symbol')], name = "trailer", toIgnore = [{},{']','[','\'','!'}])
atomExpr = AstParser([Ref('atom'),SeqParser([SeqParser([Ref('T')], atmost = 1),Ref('trailer')])], name = "atomExpr", toIgnore = [{"T"},{}])
