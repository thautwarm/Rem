...
compreh = AstParser([LiteralParser('`from`', name='\'`from`\''),SeqParser([Ref('T')], atmost = 1),Ref('exprMany'),SeqParser([SeqParser([Ref('T')], atmost = 1),LiteralParser('`not`', name='\'`not`\'')], atmost = 1),SeqParser([Ref('T')], atmost = 1),LiteralParser('`yield`', name='\'`yield`\''),SeqParser([Ref('T')], atmost = 1),Ref('lambdef')], name = 'compreh', toIgnore = [{"T"},{'`yield`','`from`'}])
