...
trailer = AstParser([LiteralParser('[', name='\'[\''),Ref('exprCons'),LiteralParser(']', name='\']\'')], name = 'trailer', toIgnore = [{},{'[',']'}])
atomExpr = AstParser([Ref('atom'),SeqParser([LiteralParser('!', name='\'!\''),SeqParser([Ref('trailer')], atleast = 1)], atmost = 1)], name = 'atomExpr', toIgnore = [{},{'!'}])
...
statement = AstParser([DependentAstParser([Ref('expr')],[Ref('let')],[Ref('into')]),SeqParser([LiteralParser(';', name='\';\'')], atmost = 1)], name = 'statement')
